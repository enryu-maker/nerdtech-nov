    ...
    <>
      ...
      <form action="#" class="space-y-8">
          <div>
              ...
              <input type="email" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="name@nerdtech.in" required/>
          </div>
          <div>
          ...
          <button type="submit" class="py-3 px-5 text-md     font-medium text-center text-black rounded-lg bg-[#f5e40b] hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 ">Send message</button>
      </form>
  </div>
